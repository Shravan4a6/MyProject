...
<hr>
<a href="excel?id=${ob.orderId}"><img alt="" src="../resources/images/ExcelDownload.png" width="60" height="30" /></a>|<a href="pdf?id=${ob.orderId}"><img alt="" src="../resources/images/PdfDownload.png" width="60" height="30" /></a>
<hr>
